...
const NeedToSubs = () => {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "20px" }}>
            ...
            Чтобы слушать музыку, Вам необходимо оформить <Link to="/subscription" style={{ color: "white" }}>подписон</Link>
            </p>
            <button
                style={{
                    position: "absolute", 
            ...
            >
                <h3 className="demo__text_h3">Оформить</h3>
            </button>
        </div>
    );
};

export default NeedToSubs;